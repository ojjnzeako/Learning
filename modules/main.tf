...
# creating VPC
module "VPC" {
  source                              = "/Users/osinzeako/Downloads/Documents/pbl/modules/VPC"
  region                              = var.region
  ...
  private_subnets                     = [for i in range(0, 8, 2) : cidrsubnet(var.vpc_cidr, 8, i)]
...
module "ALB" {
  source             = "/Users/osinzeako/Downloads/Documents/pbl/modules/ALB"
  name               = "ACS-ext-alb"
...
module "security" {
  source = "/Users/osinzeako/Downloads/Documents/pbl/modules/Security"
  vpc_id = module.VPC.vpc_id
}


module "AutoScaling" {
  source            = "/Users/osinzeako/Downloads/Documents/pbl/modules/Autoscaling"
  ami-web           = var.ami
  ami-bastion       = var.ami
  ami-nginx         = var.ami
  desired_capacity  = {
...
module "EFS" {
  source       = "/Users/osinzeako/Downloads/Documents/pbl/modules/EFS"
...
module "RDS" {
  source          = "/Users/osinzeako/Downloads/Documents/pbl/modules/RDS"
...
module "compute" {
  source          = "/Users/osinzeako/Downloads/Documents/pbl/modules/compute"
  ami-jenkins     = var.ami
  ami-sonar       = var.ami
  ami-jfrog       = var.ami
